...
<div id="content-index">
    ...
    <section class="meet-the-doctors no-bg-img team-carousel">
        ...
        <div class="container">
            ...
            <h2 class="light bordered">Nuestro <span>Equipo</span></h2>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <h2 class="light bordered">Información de la<span> terapia</span></h2>
                ...
                <div class="big-font">
                    ...
                    <div class="testimonials3 text-center" style="margin-top: 70px">
                        ...
                        <div class="owl-carousel text-carousel">
                            ...
                            <div class="item">
                                <h3>Sobre la Esquizofrenia</h3>
                                <div class="testimonials3-content">
                                    <p><i>La esquizofrenia tiene sus paraísos, del mismo modo que sus infiernos y sus
                                            purgatorios.</i></p>
                                    <p class="testimonials3-patient-detail"><span>- Aldous Huxley (1954)</span>"Las
                                        puertas de la percepción"</p>
                                </div>
