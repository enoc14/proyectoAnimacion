if(window.name == 'series_nivel2'){
	...
	var serie_array = [Math.round(Math.random()),
                    ...
                    Math.round(Math.random()),
                    Math.round(Math.random())];
    var arrayColors = [0x068905,0xff0000,0x1703ee,0xf9fb09,0x000000,0x551A8B];
	var cont = 0,
		bandera = true,
		f = 7,
		repetir = 0;
	...
	var txt_array = "array = ["+serie_array[0]+","+serie_array[1]+","+serie_array[2]+","+serie_array[3]+","+serie_array[4]+","+serie_array[5]+"]";
	...
	cuadro_principal.drawRect(0,0,600,400);	// Dibujarlo (x, y, w, h)
    ...
    let cuadro_05 = new Graphic();
	cuadro_05.beginFill(0xFFFFFF);	// Relleno del cuadro_05
	cuadro_05.lineStyle(2, 0x000000, 1);	// Borde (pixeles, color, alpha)
	cuadro_05.drawRect(0,0,200,200);	// Dibujarlo (x, y, w, h)
    cuadro_05.endFill();		// Terminar dibujo
    
    let cuadro_06 = new Graphic();
	cuadro_06.beginFill(0xFFFFFF);	// Relleno del cuadro_06
	cuadro_06.lineStyle(2, 0x000000, 1);	// Borde (pixeles, color, alpha)
	cuadro_06.drawRect(0,0,200,200);	// Dibujarlo (x, y, w, h)
	cuadro_06.endFill();		// Terminar dibujo
    ...
    let c05_text = app.renderer.generateTexture(cuadro_05);
    let c06_text = app.renderer.generateTexture(cuadro_06);

	// Crear Sprites
	let serie_numerica, cprincipal_spr, c01_spr, c02_spr, c03_spr, c04_spr, c05_spr, c06_spr;
	var att;
	loader.load(setup);
	...
	function setup() {
        ...
        c05_spr = new Sprite(c05_text);
        c06_spr = new Sprite(c06_text);
        ...
        c05_spr.position.set(400,0);
        c06_spr.position.set(400,200);
		
		att = [c01_spr,c02_spr,c03_spr,c04_spr,c05_spr,c06_spr];
		...
		btn_play.addEventListener('click', function(){
            ...
            c05_spr.interactive = false;
            c06_spr.interactive = false;
		});
        ...
        c05_spr.mouseover = () => c05_spr.tint = 0x000000;
        c05_spr.mouseout = () => c05_spr.tint = 0xffffff;
        c06_spr.mouseover = () => c06_spr.tint = 0x551A8B;
		c06_spr.mouseout = () => c06_spr.tint = 0xffffff;
        ...
        serie_numerica.addChild(c05_spr);
        serie_numerica.addChild(c06_spr);
	}
	...
	function animar() {
		...
		if(txt_cont == 3){ 	// Si no es correcta, el juego termina
			if(respuestas_Puntaje >= 2 || puntaje <= 25 ){
                ...
                att[4].interactive = false;
                att[5].interactive = false;
				txt_cont++;
